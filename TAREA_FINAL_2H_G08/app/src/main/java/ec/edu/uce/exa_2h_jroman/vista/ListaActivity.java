...
import ec.edu.uce.exa_2h_jroman.modelo.Vehiculo;



public class ListaActivity extends Activity implements InterfazCRUD {
    //datos a mostrar
    ...
    protected void onPostResume() {
        super.onPostResume();
        ListaActivity.this.aAdpt.notifyDataSetChanged();
    }

    //Crea un context Menu cuando el usuario tiene presionado sobre un item
    @Override
    ...
    // Este metodo es llamado cuando el usuario selecciona un Item en el Context menu
    @Override
    ...
    /*Hace la consulta a la BD para cargar los datos*/
    ...
    private void initList() {
        ...
        try {
            ...
            String query = "SELECT _id, placa, marca, fecFab, costo, matriculado, color, foto, estado,tipo FROM "+MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.TABLE_NAME;
            Log.e("QUERY", query);
            ...
            if(mCursor.moveToFirst()){
                do{
                    ...
                    String tipo = mCursor.getString(9);

                    Drawable draw = new BitmapDrawable(getBitmapFromString(foto));

                    vehiculo = new Vehiculo(id, placa, marca, fecFab, costo, matriculado==1?true:false, color, estado==1?true:false, draw,tipo);
    ...
    public void editarVehiculo(final AdapterView.AdapterContextMenuInfo aInfo,Object vehiculos) {
        ...
        String[] tipo = {"Automovil","Camioneta","Furgoneta"};
        spinner2.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, tipo));
        String tip = vehiculo.getTipo();
        if(tip.equals("Automovil"))
            spinner.setSelection(0);
        else if(tip.equals("Camioneta"))
            spinner.setSelection(1);
        else if(tip.equals("Furgoneta"))
            spinner.setSelection(2);
                ...
                if (!validarplaca.matches() || plac.getText().equals("")) {
                    ...
                    if (!validarfecha.matches() || fech.getText().equals("")){
                        ...
                        try {
                            ...
                            String stipo = spinner2.getSelectedItem().toString();
                            ...
                            values.put(MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.TIPO, stipo);
                            // WHERE
                            ...
                            mDb.update(
                                    ...
                                    selection,
                                    selectionArgs);
                           // actualizar(aInfo.position);
                            //actualizamos los datos del vehiculo
                            ListaActivity.this.listavehiculos.set(aInfo.position,new Vehiculo(id, placa,marca,fecha,costo,matriculado,scolor,est,fot.getDrawable(),stipo));
                            ...
                            System.out.print("---------Error no se actualizo!");
                            e.printStackTrace();
                        }
                    }
                }
...
////////////////////////////////////////////////////////////////////////////////////////7
    ...
    private String guardarJson(List<Vehiculo>listavehiculos){
        ...
        try {
            ...
            for (Vehiculo puntuacion:listavehiculos){
                ...
                objeto.put("tipo",puntuacion.getTipo());
    ...
    public void guardarArchivo (String dato,String tipoarchivo ){
        try {
            ...
            File ruta_sd = new File(Environment.getExternalStorageDirectory(), "DATOS_VEHICULOS");
            if (!ruta_sd.exists()) {
                ruta_sd.mkdirs();
            }
            ...
            archivo.flush();
            archivo.close();
            Toast t=Toast.makeText(this,"Se respaldo vehiculos!!\n"+ruta_sd, Toast.LENGTH_SHORT);
            t.show();
        } catch (IOException e){
                ...
                if (!validarplaca.matches() || plac.getText().equals("")) {
                    ...
                    if (!validarfecha.matches() || fech.getText().equals("")){
                        ...
                        try {
                            ...
                            Vehiculo vehiculo = new Vehiculo(id, placa, marca, fecha, costo, matriculado, scolor, est, drawable,stipo);
                            ...
                            // Mensaje
                            Toast.makeText(getBaseContext(), "Vehiculo agregado!!", Toast.LENGTH_LONG).show();
    ...
    public String borrar(Object id) {
        ...
        SQLiteDatabase mDb;
        mDb = mHelper.getWritableDatabase();
        String sql="DELETE FROM "+MyDbHelper.EsquemaVehiculo.ColumnasVehiculo.TABLE_NAME+" WHERE _id= "+id.toString();
        mDb.execSQL(sql);
        mHelper.close();
        mDb.close();
