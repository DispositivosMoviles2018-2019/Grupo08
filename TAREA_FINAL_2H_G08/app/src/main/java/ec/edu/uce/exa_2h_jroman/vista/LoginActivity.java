...
import ec.edu.uce.exa_2h_jroman.controlador.UsuarioControl;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void respaldo(View view) {
        ...
        Toast.makeText(getApplicationContext(), "Se respaldo usuarios!\n"+name, Toast.LENGTH_LONG).show();
    }
                ...
                if(verificarExiste()) {
                    ...
                    dialogo1.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogo1, int id) {
                            ...
                            mHelper.close();
                            mDb.close();
                            Toast.makeText(getApplicationContext(),"Nuevo usuario agregado!!", Toast.LENGTH_LONG).show();
