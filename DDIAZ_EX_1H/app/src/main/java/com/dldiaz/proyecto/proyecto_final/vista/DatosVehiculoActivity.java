...
public class DatosVehiculoActivity extends AppCompatActivity {
    ...
    ListView milistaM;
    RadioButton plomo,celeste,verde,rojo;
    int id = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  color = (EditText) findViewById(R.id.color);
        plomo =(RadioButton) findViewById(R.id.Plomo);
        celeste =(RadioButton) findViewById(R.id.Celeste);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isPlacaValida(placa.getText().toString())){
    ...
    public  boolean isPlacaValida(String placa) {
       // String expresion = "^[A-Z][0-9]{3}$";
       // Pattern pattern = Pattern.compile("^[0][9][0-9]{8}$");
        Pattern pattern = Pattern.compile("^[A-Z]{1}[A-Z]{1}[A-Z]{1}[0-9]{4}$");
