...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //USUARIO
        insert = "INSERT INTO "+ EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+ EsquemaUsuario.ColumnasUsuario.NAME+", "+ EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"Henry \",\"Guaman\")";
        db.execSQL(insert);
        insert = "INSERT INTO "+ EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+ EsquemaUsuario.ColumnasUsuario.NAME+", "+ EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"Henry\",\"Tipantuña\")";
        db.execSQL(insert);
        insert = "INSERT INTO "+ EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+ EsquemaUsuario.ColumnasUsuario.NAME+", "+ EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"Andrea\",\"Medina\")";
        db.execSQL(insert);
        insert = "INSERT INTO "+ EsquemaUsuario.ColumnasUsuario.TABLE_NAME+" ("+ EsquemaUsuario.ColumnasUsuario.NAME+", "+ EsquemaUsuario.ColumnasUsuario.PASS+") VALUES (\"Veronica\",\"Escobar\")";
        db.execSQL(insert);

        //RESERVAS
        insert = "INSERT INTO "+ EsquemaReserva.ColumnasReserva.TABLE_NAME+" ("+ EsquemaReserva.ColumnasReserva.EMAIL+", "+ EsquemaReserva.ColumnasReserva.CELULAR+", "+ EsquemaReserva.ColumnasReserva.FECRES+", "+ EsquemaReserva.ColumnasReserva.FECENT+", "+ EsquemaReserva.ColumnasReserva.VALOR+", "+ EsquemaReserva.ColumnasReserva.USER+", "+ EsquemaReserva.ColumnasReserva.PLACA+") VALUES (\"andrea@hotmail.com\",\"0983755123\",\"2018-02-06\",\"2018-02-07\",80.0, 1,\"ACD-2879\");";
        db.execSQL(insert);
